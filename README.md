This repository contains the source code submitted by LMU Munich to the WMT 2020 Unsupervised MT Shared Task. For a detailed description, check our [paper](https://arxiv.org/pdf/2010.13192.pdf). 
