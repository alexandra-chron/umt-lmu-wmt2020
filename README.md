This repository contains the source code submitted by LMU Munich to the WMT 2020 Unsupervised MT Shared Task. [(Paper link)](https://arxiv.org/abs/2010.13192). LMU Munich ranked **first** in both translation directions (German -> Sorbian, Sorbian->German). This code base is largely based on [MASS](https://github.com/microsoft/MASS/) and [RE-LM](https://github.com/alexandra-chron/relm_unmt/).
